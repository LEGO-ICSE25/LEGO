...
if __name__ == "__main__":
    ...
    with open('RQ1\\DECG_results\\miio.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #2.broadlink
    command = [r'SDK_dataset\broadlink\light.py']
    with open('RQ1\\DECG_results\\broadlink.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #3.kasa
    command = ['SDK_dataset\kasa\smartbulb.py']
    with open('RQ1\\DECG_results\\kasa.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\ring_doorbell.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #5.blinkpy
    command = [r'SDK_dataset\blinkpy\api.py',
        r'SDK_dataset\blinkpy\auth.py', ] 
    with open('RQ1\\DECG_results\\blinkpy.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pyhomematic.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\flux_led.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #11.pylutron_caseta
    command = [r'SDK_dataset\pylutron_caseta\smartbridge.py',]   
    with open('RQ1\\DECG_results\\pylutron_caseta.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pysmartthings.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #13.yeelight
    command = [r'SDK_dataset\yeelight\main.py',]   
    with open('RQ1\\DECG_results\\yeelight.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #14.pyezviz
    command = [r'SDK_dataset\pyezviz\camera.py',
               r'SDK_dataset\pyezviz\client.py']   
    with open('RQ1\\DECG_results\\pyezviz.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pybotvac.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\wled.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\switchbot.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\PyTado.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\aiohue.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pydeconz.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #21.pyfritzhome
    command = [r'SDK_dataset\pyfritzhome\fritzhome.py',]   
    with open('RQ1\\DECG_results\\pyfritzhome.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pyecobee.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\env_canada.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #24.pyvera
    command = [r'SDK_dataset\pyvera\__init__.py',]   
    with open('RQ1\\DECG_results\\pyvera.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\reolink_aio.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pyoverkiz.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\rflink.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\decora_wifi.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\aioshelly.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\homeconnect.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pyeconet.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    command = [r'SDK_dataset\pyisy\connection.py',
        ...
        r'SDK_dataset\pyisy\nodes\node.py',
        r'SDK_dataset\pyisy\nodes\nodebase.py']
    with open('RQ1\\DECG_results\\pyisy.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #33.yalexs
    command = [r'SDK_dataset\yalexs\activity.py',
        r'SDK_dataset\yalexs\api.py']
    with open('RQ1\\DECG_results\\yalexs.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #34.elgato
    command = [r'SDK_dataset\elgato\elgato.py']
    with open('RQ1\\DECG_results\\elgato.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\motioneye_client.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\apyhiveapi.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pyatmo.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #38.pydroid_ipcam
    command = [r'SDK_dataset\pydroid_ipcam\exceptions.py',
        r'SDK_dataset\pydroid_ipcam\__init__.py']
    with open('RQ1\\DECG_results\\pydroid_ipcam.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #39.haphilipsjs
    command = [r'SDK_dataset\haphilipsjs\__init__.py']
    with open('RQ1\\DECG_results\\haphilipsjs.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\onvif.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #41.pymystrom
    command = [r'SDK_dataset\pymystrom\bulb.py',
        r'SDK_dataset\pymystrom\__init__.py']
    with open('RQ1\\DECG_results\\pymystrom.txt', 'w') as file:
        file.write(str(run_script(command).stdout))


    #42.aiolifx
    command = [r'SDK_dataset\aiolifx\aiolifx.py']
    with open('RQ1\\DECG_results\\aiolifx.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #43.tellduslive
    command = [r'SDK_dataset\tellduslive\tellduslive.py']
    with open('RQ1\\DECG_results\\tellduslive.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1\\DECG_results\\pysensibo.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #45.ttls
    command = [r'SDK_dataset\ttls\client.py']
    with open('RQ1\\DECG_results\\ttls.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
