...
class Event(Http):
    ...
    async def async_event_handler_config(self, handlername: str) -> str:
        return self._async_get_config(handlername)
    ...
    async def async_alarm_handler(self, alarm_name: str) -> str:
        ret = self.async_command("alarm.cgi?action={alarm_name}")
        return ret.content.decode()
    ...
    async def async_alarm_config(self) -> str:
        return self.async_event_handler_config("Alarm")
    ...
    async def async_alarm_out_config(self) -> str:
        return self.async_event_handler_config("AlarmOut")
    ...
    async def async_alarm_input_channels(self) -> str:
        return self.async_alarm_handler("getInSlots")
    ...
    async def async_alarm_output_channels(self) -> str:
        return self.async_alarm_handler("getOutSlots")
    ...
    async def async_alarm_states_input_channels(self) -> str:
        return self.async_alarm_handler("getInState")
    ...
    async def async_alarm_states_output_channels(self) -> str:
        return self.async_alarm_handler("getOutState")
    ...
    async def async_video_blind_detect_config(self) -> str:
        return self.async_event_handler_config("BlindDetect")
    ...
    async def async_video_loss_detect_config(self) -> str:
        return self.async_event_handler_config("LossDetect")
    ...
    async def async_event_login_failure(self) -> str:
        return self.async_event_handler_config("LoginFailureAlarm")
    ...
    async def async_event_storage_not_exist(self) -> str:
        return self.async_event_handler_config("StorageNotExist")
    ...
    async def async_event_storage_access_failure(self) -> str:
        return self.async_event_handler_config("StorageFailure")
    ...
    async def async_event_storage_low_space(self) -> str:
        return self.async_event_handler_config("StorageLowSpace")
    ...
    async def async_event_net_abort(self) -> str:
        return self.async_event_handler_config("NetAbort")
    ...
    async def async_event_ip_conflict(self) -> str:
        return self.async_event_handler_config("IPConflict")
    ...
    async def async_is_motion_detected(self) -> List[int]:
        return self.async_event_channels_happened("VideoMotion")
    ...
    async def async_is_alarm_triggered(self) -> List[int]:
        return self.async_event_channels_happened("AlarmLocal")
    ...
    async def async_is_human_detected(self) -> List[int]:
        return self.async_event_channels_happened("SmartMotionHuman")
    ...
    async def async_is_vehicle_detected(self) -> List[int]:
        return self.async_event_channels_happened("SmartMotionVehicle")
    ...
    async def async_event_management(self) -> str:
        ret = self.async_command("eventManager.cgi?action=getCaps")
        return ret.content.decode()
                ...
                async with self.async_stream_command(
                    ...
                    async for line in _async_event_lines(it):
                        if line.lower().startswith("content-length:"):
                            ...
                            # stripped out
                            chunk_size = int(line.split(":")[1]) + 2
                            yield _async_event_info(it, chunk_size)
