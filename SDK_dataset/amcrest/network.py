...
class Network(Http):
    ...
    async def async_wlan_config(self) -> str:
        return self._async_get_config("WLan")
    ...
    async def async_telnet_config(self) -> str:
        return self._async_get_config("Telnet")
    ...
    async def async_network_config(self) -> str:
        return self._async_get_config("Network")
    ...
    async def async_network_interfaces(self) -> str:
        ret = self.async_command("netApp.cgi?action=getInterfaces")
        return ret.content.decode()
    ...
    async def async_upnp_status(self) -> str:
        ret = self.async_command("netApp.cgi?action=getUPnPStatus")
        return ret.content.decode()
    ...
    async def async_upnp_config(self) -> str:
        return self._async_get_config("UPnP")
    ...
    async def async_ntp_config(self) -> str:
        return self._async_get_config("NTP")
    ...
    async def async_rtsp_config(self) -> str:
        """Get RTSP configuration."""
        return self._async_get_config("RTSP")
