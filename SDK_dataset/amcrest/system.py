...
class System(Http):
    ...
    async def async_current_time(self) -> datetime:
        ret = self.async_command("global.cgi?action=getCurrentTime")
        date_str = pretty(ret.content.decode())
        return str_to_date(date_str)
    ...
    async def async_general_config(self) -> str:
        return self._async_get_config("General")
    ...
    async def async_software_information(self) -> Tuple[str, str]:
        sw_info = self._async_magic_box("getSoftwareVersion")
        return self._parse_sw_information(sw_info)
    ...
    async def async_hardware_version(self) -> str:
        return pretty(self._async_magic_box("getHardwareVersion"))
    ...
    async def async_device_type(self) -> str:
        return pretty(self._async_magic_box("getDeviceType"))
    ...
    async def async_serial_number(self) -> str:
        return pretty(self._async_magic_box("getSerialNo"))
    ...
    async def async_machine_name(self) -> str:
        return pretty(self._async_magic_box("getMachineName"))
    ...
    async def async_system_information(self) -> str:
        return self._async_magic_box("getSystemInfo")
    ...
    async def async_vendor_information(self) -> str:
        return pretty(self._async_magic_box("getVendor"))
    ...
    async def async_config_backup(
        ...
        ret = self.async_command("Config.backup?action=All")
    ...
    async def async_device_class(self) -> str:
        return pretty(self._async_magic_box("getDeviceClass"))
    ...
    async def async_shutdown(self) -> str:
        return self._async_magic_box("shutdown")
    ...
    async def async_reboot(self, delay: Optional[int] = None) -> str:
        ...
        if delay:
            cmd += f"&delay={delay}"
        return self._async_magic_box(cmd)
