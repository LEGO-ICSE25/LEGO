...
class SensiboClient:
    ...
    async def async_get_me(self) -> dict[str, Any]:
        ...
        return self._get(APIV1 + "/users/me", params)
    ...
    async def async_get_device(self, uid: str, fields: str = "*") -> dict[str, Any]:
        ...
        """
        params = {"apiKey": self.api_key, "fields": fields}
        return self._get(APIV2 + f"/pods/{uid}", params)
    ...
    async def async_get_climate_react(self, uid: str) -> dict[str, Any]:
        ...
        """
        params = {"apiKey": self.api_key}
        return self._get(APIV2 + f"/pods/{uid}/smartmode", params)
    ...
    async def async_enable_climate_react(
        ...
        """
        params = {"apiKey": self.api_key}
        return self._put(APIV2 + f"/pods/{uid}/smartmode", params, data)
    ...
    async def async_set_climate_react(
        ...
        """
        params = {"apiKey": self.api_key}
        return self._post(APIV2 + f"/pods/{uid}/smartmode", params, data)
    ...
    async def async_get_timer(self, uid: str) -> dict[str, Any]:
        ...
        """
        params = {"apiKey": self.api_key}
        return self._get(APIV1 + f"/pods/{uid}/timer/", params)
    ...
    async def async_set_timer(self, uid: str, data: dict[str, Any]) -> dict[str, Any]:
        ...
        """
        params = {"apiKey": self.api_key}
        return self._put(APIV1 + f"/pods/{uid}/timer/", params, data)
    ...
    async def async_del_timer(self, uid: str) -> dict[str, Any]:
        ...
        """
        params = {"apiKey": self.api_key}
        return self._delete(APIV1 + f"/pods/{uid}/timer/", params)
    ...
    async def async_get_schedules(self, uid: str) -> dict[str, Any]:
        ...
        """
        params = {"apiKey": self.api_key}
        return self._get(APIV1 + f"/pods/{uid}/schedules/", params)
    ...
    async def async_get_schedule(self, uid: str, schedule_id: str) -> dict[str, Any]:
        ...
        """
        params = {"apiKey": self.api_key}
        return self._get(APIV1 + f"/pods/{uid}/schedules/{schedule_id}", params)
    ...
    async def async_set_schedule(
        ...
        """
        params = {"apiKey": self.api_key}
        return self._post(APIV1 + f"/pods/{uid}/schedules/", params, data)
    ...
    async def async_set_calibration(
        ...
        """
        params = {"apiKey": self.api_key}
        return self._post(APIV2 + f"/pods/{uid}/calibration/", params, data)
    ...
    async def async_set_pureboost(
        ...
        """
        params = {"apiKey": self.api_key}
        return self._put(APIV2 + f"/pods/{uid}/pureboost", params, data)
    ...
    async def async_set_ac_states(
        ...
        return self._post(APIV2 + f"/pods/{uid}/acStates", params, data)
    ...
    async def async_set_ac_state_property(
        ...
        return self._patch(APIV2 + f"/pods/{uid}/acStates/{name}", params, data)
    ...
    async def _get(
        ...
        try:
            ...
            if retry > 0:
                asyncio.sleep(7)
                return self._get(path, params, retry - 1)
            raise error
