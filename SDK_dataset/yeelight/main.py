...
class Bulb(object):
    ...
    def set_scene(self, scene_class, *args, light_type=LightType.Main, **kwargs):
        ...
        * `COLOR` changes the light to the specified RGB color and brightness.
            ...
            Arguments:
            * **red** (*int*)         �C The red value to set (0-255).
            * **green** (*int*)       �C The green value to set (0-255).
            * **blue** (*int*)        �C The blue value to set (0-255).
            * **brightness** (*int*)  �C The brightness value to set (1-100).

        * `HSV` changes the light to the specified HSV color and brightness.

            Arguments:
            * **hue** (*int*)         �C The hue to set (0-359).
            * **saturation** (*int*)  �C The saturation to set (0-100).
            * **brightness** (*int*)  �C The brightness value to set (1-100).

        * `CT` changes the light to the specified color temperature.

            Arguments:
            * **degrees** (*int*)     �C The degrees to set the color temperature to (min/max are specified by the
        ...
        * `CF` starts a color flow.
            ...
            Arguments:
            * **flow** (`yeelight.Flow`)  �C The Flow instance to start.
        ...
        * `AUTO_DELAY_OFF` turns the light on to the specified brightness and sets a timer to turn it back off after the
          given number of minutes.
            ...
            Arguments:
            * **brightness** (*int*)     �C The brightness value to set (1-100).
            * **minutes** (*int*)        �C The minutes to wait before automatically turning the light off.
