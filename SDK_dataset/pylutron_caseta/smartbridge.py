...
class Smartbridge:
    ...
    async def _request(
        ...
        async with asyncio_timeout(REQUEST_TIMEOUT):
            response = self._leap.request(communique_type, url, body)
    ...
    async def _subscribe(
        ...
        async with asyncio_timeout(REQUEST_TIMEOUT):
            response, tag = self._leap.subscribe(
    ...
    async def turn_on(self, device_id: str, **kwargs):
        ...
        """
        self.set_value(device_id, 100, **kwargs)
    ...
    async def turn_off(self, device_id: str, **kwargs):
        ...
        :param **kwargs: additional parameters for set_value
        """
        self.set_value(device_id, 0, **kwargs)
    ...
    async def _login(self):
        ...
        try:
            ...
            project_json = self._request("ReadRequest", "/project")
    ...
    async def _ping(self):
        ...
        try:
            while True:
                ...
                self._request("ReadRequest", "/server/1/status/ping")
    ...
    async def _load_devices(self):
        ...
        device_json = self._request("ReadRequest", "/device")
    ...
    async def _load_ra3_devices(self):
        for area in self.areas.values():
            self._load_ra3_control_stations(area)
            self._load_ra3_zones(area)
    ...
    async def _load_ra3_station_device(
        ...
        button_group_json = self._request(
        ...
        device_json = self._request("ReadRequest", f"/device/{device_id}")
    ...
    async def _load_ra3_button(self, button_json, keypad_device):
        ...
        if button_led is not None:
            self._load_ra3_button_led(button_led, button_id, keypad_device)
    ...
    async def _load_lip_devices(self):
        ...
        try:
            device_json = self._request("ReadRequest", "/server/2/id")
    ...
    async def _load_scenes(self):
        ...
        scene_json = self._request("ReadRequest", "/virtualbutton")
    ...
    async def _load_buttons(self):
        ...
        button_json = self._request("ReadRequest", "/button")
        button_devices = {
            button_group: device
            for device in self.devices.values()
    ...
    async def _load_areas(self):
        ...
        area_json = self._request("ReadRequest", "/area")
    ...
    async def _load_occupancy_groups(self):
        ...
        occgroup_json = self._request("ReadRequest", "/occupancygroup")
