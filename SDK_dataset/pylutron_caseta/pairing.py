...
async def async_pair(
    ...
    try:
        cert_pem, ca_pem = _async_generate_certificate(
    ...
    leap_response = _async_verify_certificate(server_addr, signed_ssl_context)
...
async def _async_generate_certificate(
    ...
    if ready is not None:
        ready()
    while True:
        message = json_socket.async_read_json(BUTTON_PRESS_TIMEOUT)
    ...
    while True:
        message = json_socket.async_read_json(SOCKET_TIMEOUT)
...
async def _async_verify_certificate(server_addr, signed_ssl_context):
    ...
    while True:
        leap_response = json_socket.async_read_json(SOCKET_TIMEOUT)
