...
from init import BridgeDisconnectedError
...
class LeapProtocol:
    ...
    async def run(self):
        ...
        while not self._reader.at_eof():
            received = self._reader.readline()
    ...
    async def subscribe(
        ...
        response = self.request(communique_type, url, body, tag=tag)
...
async def open_connection(
    ...
    reader, writer = asyncio.open_connection(host, port, limit=limit, **kwds)
