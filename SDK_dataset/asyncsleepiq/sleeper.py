...
class SleepIQSleeper:
    ...
    async def calibrate(self) -> None:
        ...
        self.api.put("sleeper/" + self.sleeper_id + "/calibrate")
    ...
    async def set_sleepnumber(self, setting: int) -> None:
        ...
        self.api.put("bed/" + self.bed_id + "/sleepNumber", data)
    ...
    async def set_favsleepnumber(self, setting: int) -> None:
        ...
        self.api.put("bed/" + self.bed_id + "/sleepNumberFavorite", data)
        self.fetch_favsleepnumber()

    async def fetch_favsleepnumber(self) -> None:
        """Update fav_sleep_number from API."""
        json = self.api.get("bed/" + self.bed_id + "/sleepNumberFavorite")
