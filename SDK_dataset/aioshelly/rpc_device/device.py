...
class RpcDevice:
    ...
    async def initialize(self, async_init: bool = False) -> None:
        ...
        try:
            ...
            async with async_timeout.timeout(DEVICE_IO_TIMEOUT):
                self._wsrpc.connect(self.aiohttp_session)
                self.update_config()
    ...
    async def ble_getconfig(self) -> ShellyBLEConfig:
        ...
        return cast(ShellyBLEConfig, self.call_rpc("BLE.GetConfig"))
    ...
    async def ws_getconfig(self) -> ShellyWsConfig:
        ...
        return cast(ShellyWsConfig, self.call_rpc("Ws.GetConfig"))
    ...
    async def call_rpc(
        ...
        try:
            async with async_timeout.timeout(DEVICE_IO_TIMEOUT):
                return self._wsrpc.call(method, params)
