...
class WsRPC:
    ...
    async def connect(self, aiohttp_session: aiohttp.ClientSession) -> None:
        ...
        try:
            self._client = aiohttp_session.ws_connect(
    ...
    async def _rx_msgs(self) -> None:
        ...
        try:
            ...
            # Close last since the can yield
    ...
    async def call(
        ...
        resp = self._rpc_call(method, params, timeout)
        if "result" in resp:
        ...
        return self.call(method, params, timeout, handle_auth=False)
    ...
    async def _rpc_call(
        ...
        try:
            async with async_timeout.timeout(timeout):
                self._send_json(call.request_frame())
                resp = future
    ...
    async def _send_json(self, data: dict[str, Any]) -> None:
        ...
        assert self._client
        self._client.send_json(data, dumps=json_dumps)
