...
class ISY:
    ...
    async def initialize(self, with_node_servers=False):
        ...
        config_xml = self.conn.test_connection()
        ...
        isy_setup_results = asyncio.gather(*isy_setup_tasks)
        ...
        self.nodes.update(xml=isy_setup_results[0])
        if self.node_servers and with_node_servers:
            self.node_servers.load_node_servers()
