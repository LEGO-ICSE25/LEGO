...
class NodeServers:
    ...
    async def load_node_servers(self):
        ...
        self.get_node_server_profiles()
        for slot in self._slots:
            self.parse_node_server_defs(slot)
        self.loaded = True
    ...
    async def get_node_server_profiles(self):
        ...
        node_server_file_list = self.isy.conn.request(
        ...
        file_contents: List[str] = asyncio.gather(*file_tasks)
