...
class Elgato:
    ...
    async def battery(self) -> BatteryInfo:
        ...
        -------
            ...
            of the Elgato light.
        """
        data = self._request("battery-info")
    ...
    async def energy_saving(  # noqa: PLR0913
        ...
        *,
        ...
        """
        current_settings = self.battery_settings()
    ...
    async def info(self) -> Info:
        ...
        """
        data = self._request("accessory-info")
    ...
    async def settings(self) -> Settings:
        ...
        """
        data = self._request("lights/settings")
    ...
    async def identify(self) -> None:
        ...
        self._request("identify", method=METH_POST)

    async def restart(self) -> None:
        """Restart the Elgato Light device."""
        self._request("restart", method=METH_POST)
