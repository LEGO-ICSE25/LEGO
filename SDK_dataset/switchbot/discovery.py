...
class GetSwitchbotDevices:
    ...
    async def get_blind_tilts(self) -> dict[str, SwitchBotAdvertisement]:
        ...
        regular_blinds = self._get_devices_by_model("x")
        pairing_blinds = self._get_devices_by_model("X")
    ...
    async def get_curtains(self) -> dict[str, SwitchBotAdvertisement]:
        ...
        regular_curtains = self._get_devices_by_model("c")
        pairing_curtains = self._get_devices_by_model("C")
        regular_curtains3 = self._get_devices_by_model("{")
        pairing_curtains3 = self._get_devices_by_model("[")
        return {
            **regular_curtains,
            **pairing_curtains,
            **regular_curtains3,
    ...
    async def get_bots(self) -> dict[str, SwitchBotAdvertisement]:
        ...
        return self._get_devices_by_model("H")
    ...
    async def get_tempsensors(self) -> dict[str, SwitchBotAdvertisement]:
        ...
        base_meters = self._get_devices_by_model("T")
        plus_meters = self._get_devices_by_model("i")
        io_meters = self._get_devices_by_model("w")
