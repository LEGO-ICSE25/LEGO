...
class Api:
    ...
    async def get_locations(self) -> dict:
        ...
        """
        return self.get_items(API_LOCATIONS)
    ...
    async def get_location(self, location_id: str) -> dict:
        ...
        """
        return self.get(API_LOCATION.format(location_id=location_id))
    ...
    async def get_rooms(self, location_id: str) -> dict:
        ...
        """
        return self.get_items(API_ROOMS.format(location_id=location_id))
    ...
    async def get_room(self, location_id: str, room_id: str) -> dict:
        ...
        This API call is undocumented.
        """
        return self.get(API_ROOM.format(location_id=location_id, room_id=room_id))
    ...
    async def create_room(self, location_id: str, data: dict):
        ...
        This API call is undocumented.
        """
        return self.post(API_ROOMS.format(location_id=location_id), data)
    ...
    async def get_devices(self, params: Optional = None) -> dict:
        ...
        """
        return self.get_items(API_DEVICES, params=params)
    ...
    async def get_device(self, device_id: str) -> dict:
        ...
        """
        return self.get(API_DEVICE.format(device_id=device_id))

    async def get_device_status(self, device_id: str) -> dict:
        """Get the status of a specific device."""
        return self.get(API_DEVICE_STATUS.format(device_id=device_id))
    ...
    async def post_device_command(
        ...
        return self.post(API_DEVICE_COMMAND.format(device_id=device_id), data)
    ...
    async def get_apps(self, params: Optional = None) -> dict:
        ...
        """
        return self.get_items(API_APPS, params=params)
    ...
    async def get_app(self, app_id: str) -> dict:
        ...
        """
        return self.get(API_APP.format(app_id=app_id))
    ...
    async def create_app(self, data: dict) -> dict:
        ...
        """
        return self.post(API_APPS, data)
    ...
    async def update_app(self, app_id: str, data: dict) -> dict:
        ...
        """
        return self.put(API_APP.format(app_id=app_id), data)
    ...
    async def delete_app(self, app_id: str):
        ...
        """
        return self.delete(API_APP.format(app_id=app_id))
    ...
    async def get_app_settings(self, app_id: str) -> dict:
        ...
        """
        return self.get(API_APP_SETTINGS.format(app_id=app_id))
    ...
    async def update_app_settings(self, app_id: str, data: dict) -> dict:
        ...
        """
        return self.put(API_APP_SETTINGS.format(app_id=app_id), data)
    ...
    async def get_app_oauth(self, app_id: str) -> dict:
        ...
        """
        return self.get(API_APP_OAUTH.format(app_id=app_id))
    ...
    async def update_app_oauth(self, app_id: str, data: dict) -> dict:
        ...
        """
        return self.put(API_APP_OAUTH.format(app_id=app_id), data)
    ...
    async def generate_app_oauth(self, app_id: str, data: dict) -> dict:
        ...
        """
        return self.post(API_APP_OAUTH_GENERATE.format(app_id=app_id), data)
    ...
    async def get_installed_apps(self, params: Optional = None) -> dict:
        ...
        """
        return self.get_items(API_INSTALLEDAPPS, params=params)
    ...
    async def get_scenes(self, params: Optional = None):
        ...
        """
        return self.get_items(API_SCENES, params=params)
    ...
    async def execute_scene(self, scene_id: str) -> bool:
        ...
        """
        return self.post(API_SCENE_EXECUTE.format(scene_id=scene_id), data=None)
    ...
    async def get(self, resource: str, *, params: dict = None):
        """Get a resource."""
        return self.request("get", self._api_base + resource, params)

    async def get_items(self, resource: str, *, params: dict = None):
        """Perform requests for a list of items that may have pages."""
        resp = self.request("get", self._api_base + resource, params, None)
        items = resp.get("items", [])
        next_link = Api._get_next_link(resp)
        while next_link:
            resp = self.request("get", next_link, params, None)
    ...
    async def post(self, resource: str, data: Optional[Sequence]):
        ...
        return self.request("post", self._api_base + resource, data=data)

    async def put(self, resource: str, data: Optional[Sequence]):
        """Perform a put request."""
        return self.request("put", self._api_base + resource, data=data)

    async def delete(self, resource: str, *, params: dict = None):
        """Delete a resource."""
        return self.request("delete", self._api_base + resource, params)
