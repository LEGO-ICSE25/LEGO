...
class SmartThings:
    ...
    async def locations(self) -> List[LocationEntity]:
        ...
        resp = self._service.get_locations()
    ...
    async def location(self, location_id: str) -> LocationEntity:
        ...
        entity = self._service.get_location(location_id)
    ...
    async def rooms(self, location_id: str) -> List[RoomEntity]:
        ...
        resp = self._service.get_rooms(location_id)
    ...
    async def room(self, location_id: str, room_id: str) -> RoomEntity:
        ...
        entity = self._service.get_room(location_id, room_id)
        return RoomEntity(self._service, entity)

    async def create_room(self, room: Room) -> RoomEntity:
        """Create a room."""
        entity = self._service.create_room(room.location_id, room.to_data())
        return RoomEntity(self._service, entity)

    async def update_room(self, room: Room) -> RoomEntity:
        """Update a room."""
        entity = self._service.update_room(
    ...
    async def delete_room(self, location_id: str, room_id: str):
        """Delete a room."""
        return self._service.delete_room(location_id, room_id) == {}
    ...
    async def devices(
        ...
        *,
        ...
        resp = self._service.get_devices(params)
    ...
    async def device(self, device_id: str) -> DeviceEntity:
        ...
        entity = self._service.get_device(device_id)
    ...
    async def apps(self, *, app_type: Optional[str] = None) -> List[AppEntity]:
        ...
        resp = self._service.get_apps(params)
    ...
    async def update_app_settings(self, data: AppSettings) -> AppSettingsEntity:
        ...
        entity = self._service.update_app_settings(data.app_id, data.to_data())
    ...
    async def app_oauth(self, app_id: str) -> AppOAuthEntity:
        ...
        oauth = self._service.get_app_oauth(app_id)
    ...
    async def update_app_oauth(self, data: AppOAuth) -> AppOAuthEntity:
        ...
        entity = self._service.update_app_oauth(data.app_id, data.to_data())
    ...
    async def generate_app_oauth(self, data: AppOAuth) -> AppOAuthClientEntity:
        ...
        entity = self._service.generate_app_oauth(data.app_id, data.to_data())
    ...
    async def installed_apps(
        ...
        *,
        ...
        resp = self._service.get_installed_apps(params)
    ...
    async def installed_app(self, installed_app_id: str) -> InstalledAppEntity:
        ...
        entity = self._service.get_installed_app(installed_app_id)
    ...
    async def delete_subscriptions(self, installed_app_id: str) -> int:
        ...
        resp = self._service.delete_all_subscriptions(installed_app_id)
        return resp["count"]

    async def delete_subscription(self, installed_app_id: str, subscription_id: str):
        """Delete an individual subscription."""
        return self._service.delete_subscription(
    ...
    async def create_subscription(
        ...
        entity = self._service.create_subscription(
    ...
    async def scenes(self, *, location_id: Optional[str] = None):
        ...
        if location_id:
            params.append(("locationId", location_id))
        resp = self._service.get_scenes(params)
    ...
    async def execute_scene(self, scene_id: str) -> bool:
        ...
        result = self._service.execute_scene(scene_id)
    ...
    async def generate_tokens(
        ...
        result = self._service.generate_tokens(
