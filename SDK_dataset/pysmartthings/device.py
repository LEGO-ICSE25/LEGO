...
class DeviceEntity(Entity, Device):
    ...
    async def command(self, component_id: str, capability, command, args=None) -> bool:
        ...
        response = self._api.post_device_command(
    ...
    async def switch_off(
        ...
        result = self.command(component_id, Capability.switch(), Command.off)
        if result and set_status:
    ...
    async def switch_on(
        ...
        result = self.command(component_id, Capability.switch(), Command.on)
        if result and set_status:
    ...
    async def lock(
        ...
        result = self.command(component_id, Capability.lock(), Command.lock())
        if result and set_status:
    ...
    async def unlock(
        ...
        result = self.command(component_id, Capability.lock(), Command.unlock)
        if result and set_status:
    ...
    async def open(
        ...
        result = self.command(component_id, capability, Command.open)
        if result and set_status:
            attribute = (
    ...
    async def close(
        ...
        result = self.command(component_id, capability, Command.close)
        if result and set_status:
            attribute = (
                Attribute.window_shade()
                if capability == Capability.window_shade()
    ...
    async def preset_position(self, *, component_id: str = "main") -> bool:
        """Call the close device command."""
        return self.command(component_id, Capability.window_shade(), Command.close)
    ...
    async def mute(
        ...
        result = self.command(component_id, Capability.audio_mute, Command.mute())
        if result and set_status:
    ...
    async def unmute(
        ...
        result = self.command(component_id, Capability.audio_mute, Command.unmute)
        if result and set_status:
