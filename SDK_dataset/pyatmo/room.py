...
class Room(NetatmoBase):
    ...
    async def async_therm_set(
        ...
        if "NATherm1" in self.device_types or (
            ...
            self._async_set_thermpoint(mode, temp, end_time)

        else:
            self._async_therm_set(mode, temp, end_time)
    ...
    async def _async_therm_set(
        ...
        return self.home.async_set_state(json_therm_set)
    ...
    async def _async_set_thermpoint(
        ...
        self.home.auth.async_post_api_request(
