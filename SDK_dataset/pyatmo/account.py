...
class AsyncAccount:
    ...
    async def async_update_air_care(self) -> None:
        ...
        self._async_update_data(GETHOMECOACHDATA_ENDPOINT)
    ...
    async def async_update_measures(
        ...
        getattr(self.homes[home_id].modules[module_id], "async_update_measures")(
    ...
    async def _async_update_data(
        ...
        resp = self.auth.async_post_api_request(endpoint=endpoint, params=params)
        raw_data = extract_raw_data(resp.json(), tag)
        self.update_devices(raw_data, area_id)
    ...
    async def update_devices(
        ...
        for device_data in raw_data.get("devices", {}):
            ...
            if (
                ...
                self.modules[device_data["id"]].update(device_data)
