...
class SmartBulb(SmartDevice):
    ...
    so you must :func:`update()` to fetch updates values from the device.
    ...
    async def get_light_details(self) -> Dict[str, int]:
        ...
        """
        return self._query_helper(self.LIGHT_SERVICE, "get_light_details")
    ...
    async def get_turn_on_behavior(self) -> TurnOnBehaviors:
        ...
        return TurnOnBehaviors.parse_obj(
            self._query_helper(self.LIGHT_SERVICE, "get_default_behavior")
        )
    ...
    async def set_light_state(
        ...
        light_state = self._query_helper(
    ...
    async def set_hsv(
        ...
        *,
        ...
        return self.set_light_state(light_state, transition=transition)
    ...
    async def turn_off(self, *, transition: Optional[int] = None, **kwargs) -> Dict:
        ...
        :param int transition: transition in milliseconds.
        """
        return self.set_light_state({"on_off": 0}, transition=transition)
    ...
    async def turn_on(self, *, transition: Optional[int] = None, **kwargs) -> Dict:
        ...
        :param int transition: transition in milliseconds.
        """
        return self.set_light_state({"on_off": 1}, transition=transition)
