...
class SmartStrip(SmartDevice):
    ...
    async def current_consumption(self) -> float:
        ...
        return sum([plug.current_consumption() for plug in self.children])

    @requires_update
    async def get_emeter_realtime(self) -> EmeterStatus:
        """Retrieve current energy readings."""
        emeter_rt = self._async_get_emeter_sum("get_emeter_realtime", {})
    ...
    async def get_emeter_daily(
        ...
        """
        return self._async_get_emeter_sum(
    ...
    async def _async_get_emeter_sum(self, func: str, kwargs: Dict[str, Any]) -> Dict:
        ...
        self._verify_emeter()
        return merge_sums(
            [getattr(plug, func)(**kwargs) for plug in self.children]
        )
...
class SmartStripPlug(SmartPlug):
    ...
    async def _query_helper(
        ...
        return self.parent._query_helper(
