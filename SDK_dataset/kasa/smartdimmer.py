...
class SmartDimmer(SmartPlug):
    ...
    but you must :func:`update()` separately.
    ...
    async def set_brightness(
        ...
        if transition is not None:
            return self.set_dimmer_transition(brightness, transition)
    ...
    async def turn_off(self, *, transition: Optional[int] = None, **kwargs):
        ...
        """
        if transition is not None:
            return self.set_dimmer_transition(brightness=0, transition=transition)
    ...
    async def turn_on(self, *, transition: Optional[int] = None, **kwargs):
        ...
        """
        if transition is not None:
            return self.set_dimmer_transition(
    ...
    async def set_button_action(
        ...
        self._query_helper(self.DIMMER_SERVICE, action_type_setter, payload)
    ...
    async def set_fade_time(self, fade_type: FadeType, time: int):
        ...
        self._query_helper(self.DIMMER_SERVICE, fade_type_setter, payload)
