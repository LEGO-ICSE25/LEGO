...
class GenericCLIPSensor(GenericSensor):
    ...
    async def set_config(self, config):
        ...
        self._request("put", f"sensors/{self.id}/config", json=config)

    async def set_state(self, state):
        """Change state of a CLIP sensor."""
        self._request("put", f"sensors/{self.id}/state", json=state)
...
class GenericSwitchSensor:
    ...
    async def set_config(self, on=None):
        ...
        self._request("put", f"sensors/{self.id}/config", json=data)
