...
stationdata_meta = {
    ...
    "cooldegdays": {
        ...
        "french": "Degr¨¦-jour de r¨¦frig¨¦ration",
    },
    "totalrain": {
        "xpath": "./totalrain",
        "type": "float",
